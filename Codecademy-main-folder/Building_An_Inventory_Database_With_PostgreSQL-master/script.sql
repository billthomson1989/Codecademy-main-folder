...
VALUES (1, '5V resistor'), (2, '3V resistor');
...
/* Trying To Insert A Row Without A Description Throws An Error*/

INSERT INTO parts (id, code, manufacturer_id, description)
VALUES (54, 'V1-009', 9, 'some description');
...
WHERE manufacturer_id IN (manufacturer_id, parts.manufacturer_id );
